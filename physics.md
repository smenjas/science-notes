...
### [Chemical physics](https://en.wikipedia.org/wiki/Chemical_physics)

### [Particle physics](https://en.wikipedia.org/wiki/Particle_physics)
The [Standard Model](https://en.wikipedia.org/wiki/Standard_model) of particle physics describes 3 of the 4 fundamental interactions, excluding gravity.
[![A table of the fundamental particles of the standard model.](/img/standard-model.svg)](https://commons.wikimedia.org/wiki/File:Standard_Model_of_Elementary_Particles.svg)

#### [Elementary particles](https://en.wikipedia.org/wiki/Elementary_particle)

##### [Bosons](https://en.wikipedia.org/wiki/Boson)
###### [Scalar bosons](https://en.wikipedia.org/wiki/Scalar_boson)
- [Higgs](https://en.wikipedia.org/wiki/Higgs_boson)
###### [Gauge bosons](https://en.wikipedia.org/wiki/Gauge_boson) (a.k.a. [vector bosons](https://en.wikipedia.org/wiki/Vector_boson))
- [Gluon](https://en.wikipedia.org/wiki/Gluon)
- [Photon](https://en.wikipedia.org/wiki/Photon)
- [W and Z bozons](https://en.wikipedia.org/wiki/W_and_Z_bozons)

##### [Fermions](https://en.wikipedia.org/wiki/Fermion)
###### [Quarks](https://en.wikipedia.org/wiki/Quark)
- Up type quarks
  - [Up quark](https://en.wikipedia.org/wiki/Up_quark)
  - [Charm quark](https://en.wikipedia.org/wiki/Charm_quark)
  - [Top quark](https://en.wikipedia.org/wiki/Top_quark)
- Down type quarks
  - [Down quark](https://en.wikipedia.org/wiki/Down_quark)
  - [Strange quark](https://en.wikipedia.org/wiki/Strange_quark)
...
- [Tau](https://en.wikipedia.org/wiki/Tau)
- [Neutrinos](https://en.wikipedia.org/wiki/Neutrino)
  - [Electron neutrino](https://en.wikipedia.org/wiki/Electron_neutrino)
  - [Muon neutrino](https://en.wikipedia.org/wiki/Muon_neutrino)
  - [Tau neutrino](https://en.wikipedia.org/wiki/Tau_neutrino)

#### Composite particles
##### [Hadrons](https://en.wikipedia.org/wiki/Hadron) are made of 2 or more quarks
###### [Mesons](https://en.wikipedia.org/wiki/Meson) are made of an even number of quarks
- [Pion](https://en.wikipedia.org/wiki/Pion)
- [Eta meson](https://en.wikipedia.org/wiki/Eta_meson)
- [Rho meson](https://en.wikipedia.org/wiki/Rho_meson)
- [Omega meson](https://en.wikipedia.org/wiki/Omega_meson)
- [Phi meson](https://en.wikipedia.org/wiki/Phi_meson)
- [J/psi meson](https://en.wikipedia.org/wiki/J/psi_meson)
- [Upsilon meson](https://en.wikipedia.org/wiki/Upsilon_meson)
- [Theta meson](https://en.wikipedia.org/wiki/Theta_meson)
- [D meson](https://en.wikipedia.org/wiki/D_meson)
- [Kaon meson](https://en.wikipedia.org/wiki/Kaon)
- [T meson](https://en.wikipedia.org/wiki/T_meson)
- [B meson](https://en.wikipedia.org/wiki/B_meson)
###### [Baryons](https://en.wikipedia.org/wiki/Baryon) are made of an odd number of quarks
- [Neutron](https://en.wikipedia.org/wiki/Neutron)
- [Proton](https://en.wikipedia.org/wiki/Proton)
- [Lambda baryon](https://en.wikipedia.org/wiki/Lambda_baryon)
- [Sigma baryon](https://en.wikipedia.org/wiki/Sigma_baryon)
- [Xi baryon](https://en.wikipedia.org/wiki/Xi_baryon)
